...
const Options = ({children}) => {
    ...
    return (
        ...
        <div className="is-expanded">
                ...
                <button className="button is-success" disabled={name.length === 0 || idToCall.length === 0} onClick={()=>callUser(idToCall)}>
                    ...
                    <div className="control">
                        <div className="field has-addons">
                            <div className="control is-expanded">
                                <input id="yourId" onFocus={(e)=>e.target.select()} readOnly defaultValue={me} className={`input ${styles.idInput}`} type="text" />
                            </div>
                            <div className="control">
